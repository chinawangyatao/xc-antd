---
name: xc-antd
description: Build and troubleshoot React interfaces with xc-antd. Use when a task mentions xc-antd, TextField, SchemaForm, FormGroup, CrudTable, HocTable, ListPanel, ListTree, GroupedSelect, SensitiveData, ActionDrawer, or ActionModal. Covers component selection, current APIs, typed usage, examples, and verification; do not use for generic Ant Design work that does not use this library.
---
